...
export function ShowcaseCTA() {
  ...
  return (
    <section
      id="showcase-cta"
      className="relative isolate overflow-visible bg-[#E8E3F3] pt-16 pb-0 sm:pt-20 sm:pb-0 lg:overflow-x-clip lg:pt-20 lg:pb-0"
    >
      <div
      ...
      <Container className="relative z-[1] max-w-7xl">
        <div className="relative isolate">
          <div className="relative z-10 max-w-3xl pt-4 pb-6 lg:max-w-[54%] lg:pr-8 lg:pt-10 lg:pb-10">
