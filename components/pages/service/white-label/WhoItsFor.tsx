  ...
  return (
    <section className="relative overflow-hidden bg-white py-20 sm:py-24 lg:py-28 2xl:py-36">
      ...
      <Container className="relative z-10 max-w-[1440px] !px-10 lg:!px-20">
        <h2 className="type-rule-h3 max-w-xl text-center leading-tight text-[#11114d] lg:mx-auto lg:max-w-2xl">
          ...
          <div className="space-y-3 sm:space-y-4">
            {bullets.map((item) => (
              ...
              >
                ...
                />
                <p className="type-rule-h5 leading-relaxed text-[#1b1f4f] lg:leading-tight">
                  {item}
                </p>
              </div>
            ))}
