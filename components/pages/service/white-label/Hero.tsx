  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(#02063B_0%,#02063B_50%,#E6236D_100%)] pb-10 pt-32 text-white sm:pb-12 lg:pt-40 lg:pb-14 2xl:pb-16">
      ...
      <Container className="relative z-10 max-w-[1440px] !px-10 lg:!px-20">
        <div className="grid items-start gap-8 pb-8 lg:grid-cols-2 lg:gap-12 lg:pb-10 2xl:gap-16 2xl:pb-12">
          <div className="relative z-10 max-w-xl translate-y-[1.5em]">
      ...
      <Container className="relative z-10 max-w-[1440px] !px-10 lg:!px-20 pb-6 sm:pb-8 lg:pb-10">
        <div className="grid grid-cols-1 items-start gap-x-16 gap-y-10 sm:gap-y-12 lg:grid-cols-2 lg:gap-x-24 lg:gap-y-12 xl:gap-x-28 xl:gap-y-14 2xl:gap-x-32 2xl:gap-y-16">
