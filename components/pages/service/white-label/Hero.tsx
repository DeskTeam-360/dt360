...
const includedItems = [
  "Dedicated production team under your brand and client portals",
  "Website, design, funnels, CRM, video, email, automation under one subscription",
  "Consistent SLA, reporting, and project management tooling",
  "Scalable throughput without payroll complexity",
];
