  ...
  return (
    <section className="relative overflow-visible max-md:overflow-x-visible py-20 sm:py-24 lg:py-28 2xl:py-36">
      ...
      <SafeImage
        ...
        width={512}
        height={512}
        className="pointer-events-none absolute z-[2] -top-45 -left-14 h-auto w-auto max-w-[min(100px,26vw)] sm:-left-10 sm:-top-50 sm:max-w-[min(118px,28vw)] md:-left-[1rem] md:w-[16%] md:max-w-[220px] md:min-w-[120px] lg:-left-[1rem] lg:-top-55 lg:w-[10%] lg:max-w-[190px] lg:min-w-[110px]"
      />
      <SafeImage
        ...
        width={512}
        height={512}
        className="pointer-events-none absolute z-[2] -top-45 -right-14 h-auto w-auto max-w-[min(100px,26vw)] sm:-right-10 sm:-top-50 sm:max-w-[min(118px,28vw)] md:right-0 md:w-[16%] md:max-w-[220px] md:min-w-[120px] lg:right-0 lg:-top-55 lg:w-[10%] lg:max-w-[190px] lg:min-w-[110px]"
      />
