            ...
            if (href) {
              ...
              if (isInternal) {
                ...
                if (linkSlug.startsWith('blog/')) {
                  ...
                  const knownPages = ['about', 'services', 'contact', 'how-it-works', 'showcase', 'blog', 'book-a-call', 'demo-call-scheduled-thank-you', 'onboarding-call-scheduled-thank-you', 'onboarding-call-am2', 'client-meeting-with-am2', 'privacy-policy', 'terms-conditions', 'case-studies', 'affiliate-program', ''];
