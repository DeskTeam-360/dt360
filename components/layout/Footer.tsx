      ...
      <Container className="relative max-w-7xl pb-0 pt-16 sm:pb-0 sm:pt-20 lg:pb-0 lg:pt-24">
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 sm:gap-10 lg:grid-cols-[2fr_1fr_1fr_1fr] lg:gap-8 xl:gap-14">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <h4 className="mt-12 w-full font-[var(--font-poppins)] text-[30px] font-normal leading-[1.22] text-white lg:text-[32px]">
              Stop Outsourcing
              <br />
              ...
              {footerSocial.map((item) => (
                <li key={item.label}>
                  <a
                    ...
                    className="flex size-11 items-center justify-center rounded-full bg-white text-[#11104C] transition hover:bg-white/90"
...
function SocialIcon({ icon, className }: { icon: FooterSocial["icon"]; className?: string }) {
  switch (icon) {
    case "instagram":
      return (
